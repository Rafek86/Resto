...
{
    public record CreateNotificationCommand(string customerId, string message, NotificationType type = NotificationType.General) :ICommand<CreateNotificationResult>;
